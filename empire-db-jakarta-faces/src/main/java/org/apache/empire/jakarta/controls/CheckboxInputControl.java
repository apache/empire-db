...
public class CheckboxInputControl extends InputControl
{
    ...
    private final Class<? extends jakarta.faces.component.html.HtmlSelectBooleanCheckbox> inputComponentClass;
    ...
    {
        this(NAME, jakarta.faces.component.html.HtmlSelectBooleanCheckbox.class);
    }
