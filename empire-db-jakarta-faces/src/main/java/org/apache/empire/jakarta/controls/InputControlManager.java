...
public final class InputControlManager
{
    ...
    private static Class<? extends jakarta.faces.component.html.HtmlOutputLabel> labelComponentClass = jakarta.faces.component.html.HtmlOutputLabel.class;
    
    private static boolean showLabelRequiredMark = false;

    public static Class<? extends jakarta.faces.component.html.HtmlOutputLabel> getLabelComponentClass()
    {
        return labelComponentClass;
    }

    public static void setLabelComponentClass(Class<? extends jakarta.faces.component.html.HtmlOutputLabel> labelComponentClass)
    {
